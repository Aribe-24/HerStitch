...
def custom_orders():
    if request.method == "POST":
        ...
        db.execute(
            ...
            (request.form["name"], request.form["email"], request.form["event_date"], request.form["details"]),
        )
        db.commit()
        return render_template("custom_orders.html", submitted=True, active_page="custom-orders")

    return render_template("custom_orders.html", submitted=False, active_page="custom-orders")
